...
### run_20260902-221337_plan
- method: confirmed-only all-boundary uncarried sound endings CW snowball
- what it does: refreshed confirmed-only Cold War sound cores crossed with the commonest uncarried two-segment sound endings
- ran for: 35s
- platform: windows x86_64
- confirmed on: CPU
- game: BLKOPSCW
