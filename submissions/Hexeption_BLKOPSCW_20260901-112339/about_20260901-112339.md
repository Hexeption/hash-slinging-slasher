...
### run_20260901-112210_plan
- method: BO4 confirmed-only all-boundary cores x uncarried one-segment endings
- what it does: confirmed-only BO4 cores cut at every boundary, crossed with the top 100000 uncarried one-segment endings
- ran for: 14s
- platform: windows x86_64
- confirmed on: CPU
- game: BLKOPSCW
