...
### run_20260901-004551_plan
- method: BO4 confirmed-only sound all-boundary uncarried endings current
- what it does: Confirmed-only sound cores are crossed with uncarried two-segment sound endings; paths retain backslashes.
- ran for: 1m 04s
- platform: windows x86_64
- confirmed on: CPU
- game: BLKOPS04
